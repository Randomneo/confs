...
globalkeys = gears.table.join(
   ...
   awful.key({}, "XF86AudioLowerVolume", function ()
         awful.util.spawn_with_shell("amixer -q -D pulse sset Master 1%-", false)
   end),
   awful.key({}, "XF86AudioRaiseVolume", function ()
         awful.util.spawn_with_shell("amixer -q -D pulse sset Master 1%+", false)
   end),
   awful.key({}, "XF86AudioMute", function ()
         awful.util.spawn_with_shell("amixer -D pulse set Master 1+ toggle", false)
   end),
   ...
   awful.key({ modkey, "Control" }, "l",
      function ()
	 awful.spawn("i3lock -i /home/rostyslav/wallpapers/background.png") -- support only png
   end),
